                                            ...
                                            <div class="panel">
                                                ...
                                                <div class="panel-body p-20">
                                                    ...
                                                    <div class="section-title">
                                                        <p class="sub-title">Système de gestion des étudiants</p>
                                                    </div>

                                                    <form class="form-horizontal" method="post">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-6 control-label">Recherchez votre résultat</label>
                                                            <div class="col-sm-6">
                                                               <a href="find-result.php">Cliquez ici</a>
                                                            </div>
                                                        </div>
                                ...
                                <div class="col-md-10 col-md-offset-1 pt-50">
                                    ...
                                    <div class="row mt-30 ">
                                        <div class="col-md-11">
                                                    ...
                                                    <form class="form-horizontal" method="post">
                                                        ...
                                                        <div class="form-group mt-20">
                                                    		<div class="col-sm-offset-2 col-sm-10">
                                                    			...
                                                    			<button type="submit" name="login" class="btn btn-success btn-labeled pull-right">Se connecter<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                    		</div>
                                                    	</div>
                                                    </form>
                                            ...
                                            <!-- /.panel -->
                                            <p class="text-muted text-center"><small>Copyright © 2020 IWA  </a></small> </p>
                                        </div>
                                        <!-- /.col-md-11 -->
                                    </div>
                                    <!-- /.row -->
