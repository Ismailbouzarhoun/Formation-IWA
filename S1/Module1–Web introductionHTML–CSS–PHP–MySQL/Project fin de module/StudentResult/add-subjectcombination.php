...
if($lastInsertId)
{
$msg="la combinaison a été ajouté";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <title>IWA Administrateur Créer une Combinaison< </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Créer une Combinaiso</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> modules</li>
                                        <li class="active">Créer une Combinaison</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Créer une module Combinaison</h5>
                                                </div>
                                            </div>
...
<option value="">Sélectionner une module</option>
