...
$query->execute();
$msg="Informations sur le modules a été modifier";
}
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>IWA Administrateur modifier les modules</title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">modifier le module</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> modules</li>
                                        <li class="active">modifier le module</li>
                                    </ul>
                                </div>
