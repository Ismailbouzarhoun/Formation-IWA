...
<html lang="en">
    <head>
        ...
        <title>IWA Administrateur modifier la classe</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">modifier la classe</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">modifier la classe</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Modifier les informations sur la classe d'étudiant</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Nom de la classe</label>
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Par exemple - Java, Python, etc</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Nom de la classe en numeric</label>
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Par exemple - M1, M2, etc</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Par exemple - A, B, etc</span>
                                                        </div>
                                                    </div>
                                                    <?php }} ?>
  <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="update" class="btn btn-success btn-labeled">modifier<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                    </div>
