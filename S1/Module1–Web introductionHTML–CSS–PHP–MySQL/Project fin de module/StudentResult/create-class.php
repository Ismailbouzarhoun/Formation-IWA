...
<html lang="en">
    <head>
        ...
        <title>IWA Administrateur Créer une classe</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Créer une classe</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Créer une classe</li>
            						</ul>
                                </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Nom du classe</label>
                                                		<div class="">
                                                       ...
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Nom de la classe en numérique</label>
                                                        <div class="">
                                                            <input type="number" name="classnamenumeric" required="required" class="form-control" id="success">
                                                            <span class="help-block">Par exemple 1,2,4,5 etc</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Par exemple A,B,C etc</span>
                                                        </div>
                                                    </div>
  <div class="form-group has-success">
