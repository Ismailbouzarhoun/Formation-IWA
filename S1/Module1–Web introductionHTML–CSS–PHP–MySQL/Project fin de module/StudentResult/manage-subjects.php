...
<html lang="en">
    <head>
        ...
        <title>IWA Administrateur gérer les modules</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">gérer les modules</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> modules</li>
            							<li class="active">gérer les modules</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Afficher les informations sur les modules</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
