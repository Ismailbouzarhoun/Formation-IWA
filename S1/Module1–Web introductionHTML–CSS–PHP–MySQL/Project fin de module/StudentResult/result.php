...
<html lang="en">
    <head>
        ...
        <title>Système résultats des étudiants</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">résultats des étudiants</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
{   ?>
<p><b>Nom d'étudiant :</b> <?php echo htmlentities($row->StudentName);?></p>
<p><b>Numéro d'identification de l'étudiant :</b> <?php echo htmlentities($row->RollId);?>
<p><b>Classe d'étudiant :</b> <?php echo htmlentities($row->ClassName);?>(<?php echo htmlentities($row->Section);?>)
<?php }
...
?>
<tr>
                                                <th scope="row" colspan="2">note global</th>
<td><b><?php echo htmlentities($totlcount); ?></b>/<b><?php echo htmlentities($outof=($cnt-1)*20); ?></b></td>
                                                        </tr>
<tr>
                                                <th scope="row" colspan="2">Télécharger le résultat</th>           
                                                            <td><b><a href="download-result.php">Télécharger </a> </b></td>
                                                             </tr>
