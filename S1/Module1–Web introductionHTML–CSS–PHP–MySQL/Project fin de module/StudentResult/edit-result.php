...
$msg="Les résultat ont été mises à jour";
}
}
}
...
<html lang="en">
    <head>
        ...
        <title>IWA Administrateur modifier les résultats </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">les résultats des étudiants</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">les résultats</li>
                                    </ul>
                                </div>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">noms complets</label>
<div class="col-sm-10">
