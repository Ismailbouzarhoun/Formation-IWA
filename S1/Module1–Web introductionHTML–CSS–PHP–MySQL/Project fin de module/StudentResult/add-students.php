...
<html lang="en">
    <head>
        ...
        <title>IWA Administrateur Créer une étudiant </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Créer une étudian</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Créer une étudiant</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Remplissez les informations sur l'étudiant</h5>
                                                </div>
                                            </div>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Apogie</label>
<div class="col-sm-10">
