...
$gender=$_POST['gender']; 
$moduleId=$_POST['class']; 
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  tblprof(profName,RollId,profEmail,Gender,moduleId,DOB,Status) VALUES(:profname,:roolid,:profemail,:gender,:moduleid,:dob,:status)";
$query = $dbh->prepare($sql);
$query->bindParam(':profname',$profname,PDO::PARAM_STR);
$query->bindParam(':roolid',$roolid,PDO::PARAM_STR);
$query->bindParam(':profemail',$profemail,PDO::PARAM_STR);
$query->bindParam(':gender',$gender,PDO::PARAM_STR);
$query->bindParam(':moduleid',$moduleId,PDO::PARAM_STR);
...
if($lastInsertId)
{
$msg="le professeur a été ajouter";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <title>IWA Administrateur Créer une professeur </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Créer une professeur</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Créer une professeur</li>
                                    </ul>
                                </div>
...
<option value="">Sélectionnez une module</option>
